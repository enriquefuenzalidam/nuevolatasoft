    ...
    return (
        <main className={` flex-grow `}>
            ...
            <div className={` absolute top-0 left-0 w-full h-full bg-[rgba(97,61,210,0.3)] `} />
                ...
                {/* chevrons section */}
                <div className={` relative bg-white bg-opacity-20 py-12 max-w-5xl mx-auto `}>

                    <div className={` overflow-hidden flex flex-row `}>
                        <div className={` mx-4 flex flex-col opacity-30 pointer-events-none `}>
                            <div className={` flex-grow bg-[rgba(97,61,210,0.8)] p-6 text-white rounded-xl w-60 text-center `}>
                        ...
                        <div className={` mx-4 flex flex-col `}>
                            <div className={` flex-grow bg-[rgba(255,255,0,0.8)] p-6 text-black rounded-lg w-60 text-center `}>
                        ...
                        <div className={` mx-4 flex flex-col `}>
                            <div className={` flex-grow bg-[rgba(97,61,210,0.8)] p-6 text-white rounded-lg w-60 text-center `}>
